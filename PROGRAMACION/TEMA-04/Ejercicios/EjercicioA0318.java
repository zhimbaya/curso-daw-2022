...
public class EjercicioA0318 {

	public static void main(String[] args) {
		/*
		 * Utilizando la sentencia for confeccionar un programa que permita ingresar un
		 * valor del 1 al 10 y nos muestre la tabla de multiplicar del mismo (los
