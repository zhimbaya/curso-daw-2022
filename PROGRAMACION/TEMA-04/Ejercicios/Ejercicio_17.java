...
public class Ejercicio_17 {
    ...
    public static void main(String[] args) {
         ...
         *
         * Las edades de 50 estudiantes del turno mañana. (entre 16 y 28 años
         * ambos inclusive) Las edades de 60 estudiantes del turno tarde. (entre
         * 16 y 35 años ambos inclusive) Las edades de 110 estudiantes del turno
         * noche. (entre 18 y 45 años ambos inclusive) Las edades de cada
         * estudiante deben calcularse de forma aleatoria usando el método
         * random de la clase Math.
         *
         * Para cada uno de los turnos se pide: a) Obtener la mínima, la máxima
         * y el promedio de las edades de cada turno b) Mostrar por pantalla un
         * mensaje que indique cual de los tres turnos tiene un promedio de
         * edades mayor
         */
