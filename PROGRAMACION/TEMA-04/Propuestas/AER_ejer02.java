...
public class AER_ejer02 {
    ...
    public static void main(String[] args) {
         ...
         * consumiciones. Además, según dicen en los telediarios, la ley
         * antitabaco le está perjudicando aún más. Como no termina de creerse
         * todo lo que dicen en la televisión, ha decidido hacer un estudio de
         * mercado semanal de su establecimiento. Para ello, ha estado apuntando
         * la caja diaria que se ha realizado en las últimas semanas. Le
         * gustaría saber qué día de la semana se producen el mayor y el menor
         * número de ventas, y si las ventas del domingo superan a la media
         * semanal. De esta manera podrá establecer estrategias de marketing que
         * le permitan recuperar algo de las ganancias perdidas.
         *
         * Javier abre su bar todos los días menos los Lunes, que utiliza para
         * descansar.
         *
         * Realiza un programa que ayude a Javier en su cometido. Dada una lista
         * de valores correspondiente a una semana, nuestro programa deberá
         * decirle a Javier el día de la semana que más y menos ha vendido, y si
         * las ventas del domingo superan la media. Haga clic en el enlace
         * https://www.aceptaelreto.com/problem/statement.php?id=105 para abrir
         * el recurso.
         */
