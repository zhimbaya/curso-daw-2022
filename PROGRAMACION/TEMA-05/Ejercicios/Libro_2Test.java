...
public class Libro_2Test {
    ...
    public static void main(String[] args) {
        ...
        Libro_2 libro1 = new Libro_2("El quijote", "Cervantes", 1, 0);
        //se crea el objeto libro2 utilizando el constructor por defecto
        Libro_2 libro2 = new Libro_2();
        ...
        System.out.println("Total de libros: " + Libro_2.getTotalLibros());
        System.out.println("Total Prestados: " + Libro_2.getTotalPrestados());
        System.out.println();
