...
public class Notas {
    ...
    public static void main(String[] args) {
        ...
        //Declaramos y creamos un array de 25 notas con datos generados aleatoriamente 
        //(lo hacemos así por comodidad o vaguería, según se mire)  
        int[] notas = new int[25];

        //Carga de los datos. Al aplicar el casteo, truncamos la parte decimal 
        //generada por Math.random()
